.. warning::
    This page has been migrated to varssos-mkdocs (docs/embedded_linux/openwrt/openwrt_sdk/makefile_feeds.md). This copy is outdated and no longer maintained.
