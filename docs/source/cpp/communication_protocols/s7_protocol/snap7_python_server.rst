.. warning::
    This page has been migrated to varssos-mkdocs (docs/cpp/communication_protocols/s7_protocol/snap7_python_server.md). This copy is outdated and no longer maintained.
