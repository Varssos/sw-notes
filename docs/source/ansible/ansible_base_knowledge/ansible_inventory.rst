.. warning::
    This page has been migrated to varssos-mkdocs (docs/iac_and_automation/ansible/ansible_base_knowledge/ansible_inventory.md). This copy is outdated and no longer maintained.
